...
namespace PacMan
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Ghost 2 (Horizontal) Information
            char previousH2 = ' ';
            int ghostH2X = 5;
            int ghostH2Y = 29;
            string ghostH2direction = "left";

            // Ghost 3 (Vertical) Information
            char previous2 = ' ';
            int ghost2X = 20;
            int ghost2Y = 57;
            ...
            // Ghost 4 (Vertical) Information
            char previousV2 = ' ';
            int ghostV2X = 10;
            int ghostV2Y = 47;
            string ghostV2direction = "up";

            // Ghost 5 (Random) Information
            char previous3 = ' ';
            int ghost3X = 19;
            int ghost3Y = 25;

            // Ghost 6 (Random) Information
            char previousR2 = ' ';
            int ghostR2X = 9;
            int ghostR2Y = 15;

            // Ghost 7 (Smart) Information
            char previous4 = ' ';
            int ghost4X = 13;
            int ghost4Y = 30;
            ...
            while (true)
            {
                ...
                if (count1 == 5)            // Slowest Movement
                {
                    ...
                    gameRunning = moveGhostInLine(ref ghostH2direction, maze, ref ghostH2X, ref ghostH2Y, ref previousH2);
                    if (gameRunning == false)
                    {
                        break;
                    }
                ...
                if (count2 == 2)            // Slow Movement
                {
                    ...
                    gameRunning = moveGhostInLine(ref ghostV2direction, maze, ref ghostV2X, ref ghostV2Y, ref previousV2);
                    if (gameRunning == false)
                    {
                        break;
                    }
                ...
                gameRunning = moveGhostRandom(maze, ref ghostR2X, ref ghostR2Y, ref previousR2);
                if (gameRunning == false)
                {
                    break;
                }
                ...
                gameRunning = moveGhostSmart(maze, ref ghostS2X, ref ghostS2Y, ref previousS2, pacmanX, pacmanY);
                if (gameRunning == false)
                {
                    break;
                }
